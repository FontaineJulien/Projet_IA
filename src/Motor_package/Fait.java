...
public class Fait {
	...
	/**
	 * Convertit une chaine de caractère en un fait.
	 * Gère l'évaluation du "!" en début de de chaîne.
	 * @param label
	 * @return
	 */
	...
	/**
	 * Transforme une liste de string(représentant des faits) en une liste de Fait.
	 * @param liste_fait
